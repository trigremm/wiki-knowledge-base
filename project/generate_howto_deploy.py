...
HOWTO_TEMPLATE = """
python project/generate_howto_deploy.py -w {www_domain} -r {repo_url}
...
ls -alsht projects/{www_domain}
cp projects/{www_domain} /etc/nginx/sites-available/{www_domain}
